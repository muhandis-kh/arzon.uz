...
url = 'https://uzum.uz/uz/search?query=asus&needsCorrection=1'
...
if response.status_code == 200:
    # Sayfa içeriğini analiz etmek için BeautifulSoup kullanma
    soup = BeautifulSoup(response.text, 'html.parser')

    # İlgili verilere ulaşma ve işleme
    # Örneğin:
    ...
    print('Sayfa çekme hatası:', response.status_code)
