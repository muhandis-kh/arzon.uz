...
ALLOWED_HOSTS = ['127.0.0.1', '.vercel.app', '.now.sh', '.onrender.com', '.pythonanywhere.com', 'arzonuz.up.railway.app']
...
STATICFILES_STORAGE = 'whitenoise.storage.ComressedManifestStaticFilesStorage'
